  ...
  if(message.content.startsWith('@here')){
    ...
    if (args[0]) {
      ...
      let emx = new MessageEmbed()
        .setDescription(`:point_right: [Support Server](https://discord.com/invite/U9YGk2kbGV) ✬ [YouTube](https://www.youtube.com/channel/UC_PoRDRtkGfRBkrOoIcLiCg) :point_left:`)
        .setColor("RANDOM")
        .setThumbnail(client.user.displayAvatarURL());
